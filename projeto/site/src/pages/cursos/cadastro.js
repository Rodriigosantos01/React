...
export class CursoCadastro extends React.Component {
    ...
    adicionar = async (e) => {
        ...
        try{
            ...
            let msgErro;
            if(_id && _id !== ''){
                msgErro = 'Ocorreu um erro ao atualizar o curso, tente novamente';
            }else{
                msgErro = 'Ocorreu um erro ao cadastrar o curso, tente novamente';
            }
            console.log(msgErro);
        }
    }
    ...
    deletar = async(_id) =>{
        try{
            if(window.confirm('Deseja realmente delear o curso ?')){
            ...
            console.log(error);
            alert('Ocorreu erro ao dletar Curso');
